...
public class PartnerTypesManager : IPartnerTypesManager
{
    ...
    public async Task<ICollection<ListItem<byte>>> GetPartnerTypesByPartnerIdAsync(int partnerId,
    ...
    public async Task<ICollection<PartnerTypes>> GetPartnerTypesCollectionAsync(int partnerId,
        CancellationToken cancellationToken)
    {
        var partnerTypes =
            await _partnerTypesRepository.GetEntitiesAsync(x => x.PartnerId == partnerId, cancellationToken);
    ...
    public async Task<PartnerTypes> AddPartnerTypeAsync(int partnerId, PartnerType type,
        CancellationToken cancellationToken)
    {
        var dbPartnerType =
    ...
    public async Task RemovePartnerTypeByEventBusAsync(int partnerId, PartnerType type,
        CancellationToken cancellationToken)
    {
        var dbPartnerType =
            await _partnerTypesRepository.GetEntityAsync(x => x.PartnerId == partnerId && x.Type == type,
    ...
    public async Task RemovePartnerTypeByRabbitMQAsync(int partnerId, PartnerType type,
        CancellationToken cancellationToken)
    {
        var dbPartnerType =
            await _partnerTypesRepository.GetEntityAsync(x => x.PartnerId == partnerId && x.Type == type,
    ...
    public async Task RemovePartnerTypeByKafkaAsync(int partnerId, PartnerType type,
        CancellationToken cancellationToken)
    {
        var dbPartnerType =
            await _partnerTypesRepository.GetEntityAsync(x => x.PartnerId == partnerId && x.Type == type,
