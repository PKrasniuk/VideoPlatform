...
{
    public async Task<(string filePath, string thumbnailPath, string logoPath)> UploadFileToStorageAsync(IFormFile file,
    ...
    public async Task<string> UploadFileByTypeToStorageAsync(IFormFile file, FileTypeEnum fileType,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<bool> RemoveFileByTypeFromStorageAsync(string filePath, FileTypeEnum fileType,
        CancellationToken cancellationToken)
    {
