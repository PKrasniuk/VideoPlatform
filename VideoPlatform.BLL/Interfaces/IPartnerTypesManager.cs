...
namespace VideoPlatform.BLL.Interfaces
{
    public interface IPartnerTypesManager
    {
        ...
        Task<ICollection<ListItem<byte>>> GetPartnerTypesByPartnerIdAsync(int partnerId, CancellationToken cancellationToken = default);

        Task<ICollection<PartnerTypes>> GetPartnerTypesCollectionAsync(CancellationToken cancellationToken = default);

        Task<ICollection<PartnerTypes>> GetPartnerTypesCollectionAsync(int partnerId, CancellationToken cancellationToken = default);

        Task<PartnerTypes> AddPartnerTypeAsync(int partnerId, PartnerType type, CancellationToken cancellationToken = default);

        Task RemovePartnerTypeAsync(int partnerId, PartnerType type, CancellationToken cancellationToken = default);

        Task RemovePartnerTypeByEventBusAsync(int partnerId, PartnerType type, CancellationToken cancellationToken = default);

        Task RemovePartnerTypeByRabbitMQAsync(int partnerId, PartnerType type, CancellationToken cancellationToken = default);
