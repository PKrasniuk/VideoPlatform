...
{
    [ColumnName("Label")] [LoadColumn(0)] public uint Label { get; set; }
    ...
    [ColumnName("SumTfAnchor")]
    [LoadColumn(22)]
    public float SumTfAnchor { get; set; }


    [ColumnName("SumTfTitle")]
    [LoadColumn(23)]
