...
namespace VideoPlatform.Api.Infrastructure.Configurations
{
    /// <summary>
    /// MimeType Names
    /// </summary>
    public static class MimeTypeNames
    {
        ...
        ///<summary>ECMAScript/JavaScript; Defined in RFC 4329 (equivalent to application/ecmascript but with looser processing rules) It is not accepted in IE 8 or earlier -
        /// text/javascript is accepted but it is defined as obsolete in RFC 4329. The "type" attribute of the <script></script> tag in HTML5 is optional and in practice omitting
        /// the media type of JavaScript programs is the most interoperable solution since all browsers have always assumed the correct default even before HTML5.</summary>
        ...
        /// However,text/javascript is allowed in HTML 4 and 5 and, unlike application/javascript, has cross-browser support. The "type"
        /// attribute of the <script></script> tag in HTML5 is optional and there is no need to use it at all since all browsers
        /// have always assumed the correct default (even in HTML 4 where it was required by the specification).</summary>
        [Obsolete]
